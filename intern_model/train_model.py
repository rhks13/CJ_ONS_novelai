...
class GenerationModelTrainer():
    ...
    def load_lm_dataset(self, df_path, word_tokenizer, data_training_args):
        ...
        datasets = load_dataset('csv', data_files=data_files, cache_dir='./cache')
    ...
    def run(self, runtype = 'train'):
        ...
        filtered_path = 'preprocess_dir/preprocessed.csv'
        #df.to_csv(filtered_path,index=False)
        #df = pd.read_csv('./preprocessed.csv')
        #filtered_path = './preprocessed.csv'
        if runtype == 'train':
            word_tokenizer = WordTokenizer()
            
            # load dataset and model
            lm_datasets = self.load_lm_dataset(filtered_path, word_tokenizer, data_training_args = self.arguments.data_training_args)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--file_path", help="file_path", default = './data/novel_data_all_12_12_1.csv', type=str)
    parser.add_argument("--model_save_path", help="model_save_path", default = 'model_original', type=str)
